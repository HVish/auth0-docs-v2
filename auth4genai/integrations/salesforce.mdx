...
Connect your AI agents to Salesforce for CRM capabilities, customer data access, and sales process automation. It is designed for applications that need to interact with Salesforce's customer records, opportunities, cases, and other business objects.
...
- **Customer relationship management**: Access customer records, contacts, and account information for personalized AI interactions.
- **Sales automation**: Retrieve and manage sales opportunities, leads, and forecasting data.
- **Service and support**: Access support cases, knowledge base articles, and service metrics for intelligent customer service.
- **Marketing insights**: Analyze campaign performance, lead generation, and customer engagement metrics.
- **Data analytics**: Generate reports and insights from Salesforce data to drive business decisions.
- **Workflow automation**: Create and update records, trigger processes, and automate business workflows.

## Overview

The Salesforce integration is perfect for business-focused AI applications that need to interact with customer data, manage sales processes, automate support workflows, or provide insights from CRM data. This integration provides access to Salesforce's comprehensive APIs for all standard and custom objects.
...
<Steps>
  <Step title="Salesforce setup">
    ...
    2. In your Salesforce org, navigate to **Setup** → **App Manager**.
    ...
    5. In the **API (Enable OAuth Settings)** section:
       ...
       - **Require Secret for Refresh Token Flow**: Check this option
    6. **Important Token Configuration** (for optimal Token Vault compatibility):
       ...
       - Enable **Allow Refresh Token Rotation** for enhanced security
       - Set **Access Token Format** to **JWT** (not opaque) to avoid 10-minute token expiry limitations
    7. Click **Save** and wait for the app to be created.
...
- See a complete example in our [Get Salesforce Opportunities how-to guide](/how-tos/get-salesforce-opportunities).
