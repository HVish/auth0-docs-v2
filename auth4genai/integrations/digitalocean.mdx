...
The DigitalOcean integration is perfect for DevOps and infrastructure management AI applications that need to interact with cloud resources, automate deployment processes, monitor infrastructure health, or optimize cloud costs. This integration provides access to DigitalOcean's comprehensive API for managing all aspects of cloud infrastructure.
...
<Steps>
  <Step title="DigitalOcean setup">
    ...
    3. Click **New Application** to register a new OAuth application.
    4. Fill in the application details:
       ...
       <FindDomainInfoBlock />
    5. Click **Create Application** and note your **Client ID** and **Client Secret**.
...
<TokenVaultConfigBlock 
  ...
  scopes={["account:read", "droplet:read", "droplet:create", "kubernetes:read", "project:read"]}
/>
